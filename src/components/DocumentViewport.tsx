  ...
  return (
    <section
      ...
      class={cx(
        ...
        !hasDocument && "grid place-items-center",
    ...
    >
      <label
        id="empty-state"
        class={cx(
          "empty-state text-text-secondary min-h-[220px] w-[min(520px,100%)] cursor-pointer content-center place-items-center gap-2.5 rounded-control border border-dashed border-[#b9c2d0] bg-(--color-empty-surface) text-center backdrop-blur-[10px] max-compact:min-h-[200px]",
